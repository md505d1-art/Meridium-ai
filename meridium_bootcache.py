"""Compile the classic runtime once per worker — Streamlit reruns stay snappy."""
...
def _download() -> str:
    ...
    for url in (_BASE, _CDN):
        try:
            req = urllib.request.Request(url, headers={"User-Agent": "Meridium/44"})
